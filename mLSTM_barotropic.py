...
# checkpoints setting
parser.add_argument('-c', '--checkpoint', default='checkpoint/mLSTM', type=str, metavar='PATH',
...
for i in range(it):    
    ...
    # model
    model = models.mLSTM(input_size = training_set.size, hidden_size = training_set.size*2, output_size=training_set.size)
